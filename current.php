...
<body>
	...
	<div>
		<div class="fir_di_open_sav">
			<div>
				<img src="img/curnt.png" alt="img" class="openacpageimg">
			</div>
			<div class="fir_di_open_s">
				<h1 class="openaconlineh1">Get the <b>BDIC Bank Digital</b></h1>
				<h1 class="openaconlineh1">Current Account <b>Online</b></h1>
		...
		<div class="fir_di_open_sav1">
			<div class="fir_di_open_sav12">
				...
				<h3>Open your Current Account instantly from the comfort of your home</h3>
				<ul class="normalli1">
				  <li>Combined Cash Deposit (Anywhere in India) – 12 times of Current Month AMB (upper cap of Rs. 75 Crs.)</li>
				  <li>Cash Withdrawal (Non-home Branch) – 12 times of Current Month AMB (upper cap of Rs. 75 Crs.)</li>
				  <li>DD – Unlimited DD at Bank location; Free up to Rs. 30 lakhs at Correspondent Bank Location</li>
				  <li>Cheque Leaves – Free 100 cheque leaves for every Rs. 1 lakh of balance maintained</li>
				  <li>Total Transactions – 150 transactions for every Rs. 1 lakh of balance maintained</li>
				  <li>Collect customer payments using Android DIGI POS machine with ZERO monthly rental</li>
				  <li>All Cheque based transactions i.e., Payment or Collection being local/anywhere or Fund Transfer within BDIC Bank and cheque pick-up services</li>
				  <li>Free cheque pick-up once in a day. Cash pick-up/doorstep Banking services offered at select locations</li>
				  <li>Outstation Cheque Collection at all BDIC Bank branches/speed clearing</li>
				  <li>Insta Alert, BillPay and Standing Instructions (Set-up)</li>
				</ul>
				<h3>Key highlights</h3>
				<ul class="normalli">
					<li><b>Get your account number Within 24Hour</b></li>
					<li><b>Enjoy instant access to Net / MobileBanking</b></li>
					<li><b>Extended Zero NMC1,2 charges</b></li>
			...
			<div class="HideShowdetail">
				<div class="FEATURES">
					<div class="hide-div-fet">
						...
						<p>Instant account opening is easy with BDIC Bank. All you need is a working <b>mobile number, Aadhaar number, Bussiness Details</b> and a <b>PAN</b> number to open an account.</p>
					</div>
					<hr>
					<div class="hide-div-fet">
						<h4 class="hide-div-feth42">4 easy steps</h4>
						<div class="sub_hide_div">
						<p>Your instant Current Account or Salary Account is fully functional in 4 easy steps:</p>
						<ul>
					...
					<div class="hide-div-fet">
						...
						<p>Get your account number and Customer ID immediately You will receive your account number and Customer ID as soon as you open an BDIC Bank current Account online.  It's <b>immediate!</b></p>
					</div>
					<hr>
					<div class="hide-div-fet">
					...
					<div class="hide-div-fet">
						...
						<p>Your instant Online Current Account is NetBanking and <b>Mobile Banking enabled</b>, so it's easy to check your balances and many more immediately once you have set your password</p>
					</div>
					</div>
					<hr>
					<div class="hide-div-fet">
				...
				<div class="Eligibility" style="display:none;">
					<div class="hide-div-fet">
						...
						<div class="sub_hide_div">
						<p>Here are the BDIC Bank Current Account eligibility criteria you need to meet:</p>
						<ul>
				...
				<div class="Money" style="display:none;">
					<div class="hide-div-fet">
						...
						<p>If your Account open success than you must maintain <b>1,00,000 plus </b>in your current account.</p>
					</div>
					<div class="hide-div-fet">
